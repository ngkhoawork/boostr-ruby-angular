SwitchUser.setup do |config|
  ...
  config.view_guard = ->(current_user, request, original_user) { current_user && current_user.is?(:superadmin) || original_user && original_user.is?(:superadmin) }
  ...
  config.controller_guard = ->(current_user, request, original_user) { 
    ...
    current_user && current_user.authorized_switch_to?(user)
  }
end
