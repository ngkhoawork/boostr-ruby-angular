class Facts::AccountProductPipelineFactService < BaseService
  ...
  def find_or_create_facts
    Facts::AccountProductPipelineFactCreationHandler.perform(calculated_facts: calculated_pipelines,
  ...
  def pipeline_service
    Facts::AccountProductPipelineCalculationService.perform(company_id: company_id,
