class Facts::AccountProductRevenueFactCreationHandler < BaseService
  ...
  def unused_records
    AccountProductRevenueFact.where('time_dimension_id = :time_dimension_id AND process_ran_at < :process_date_time
