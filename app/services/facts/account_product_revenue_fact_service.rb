class Facts::AccountProductRevenueFactService < BaseService
  ...
  def find_or_create_facts
    Facts::AccountProductRevenueFactCreationHandler.perform(calculated_facts: calculated_revenues,
  ...
  def revenue_service
    Facts::AccountProductRevenueCalculationService.perform(company_id: company_id,
