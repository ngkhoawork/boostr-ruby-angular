class Csv::ProductMonthlySummaryService < Csv::BaseService
  ...
  def headers
    ...
    headers.concat ['Record Type', 'Team Member', 'Name', 'Advertiser', 'Agency', 'Holding CO', 'Stage', '%', 'Budget', 'Budget USD', 'Start Date', 'End Date', 'Created Date', 'Closed Date', 'Deal Type', 'Deal Source']
  end
end
