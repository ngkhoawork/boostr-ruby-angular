@app.controller "InfluencerContentFeesEditController",
['$scope', '$rootScope', '$modalInstance', 'Influencer', 'InfluencerContentFee', 'Currency', 'CurrentUser', 'influencerContentFee', 'io'
($scope, $rootScope, $modalInstance, Influencer, InfluencerContentFee, Currency, CurrentUser, influencerContentFee, io) ->

  $scope.formType = "Reassign"
  ...
  $scope.submitForm = () ->
    ...
    InfluencerContentFee.update(io_id: $scope.io.id, id: $scope.influencerContentFee.id, influencer_content_fee: $scope.influencerContentFee).then(
