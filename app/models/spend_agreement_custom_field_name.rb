class SpendAgreementCustomFieldName < ActiveRecord::Base
  ...
  def assign_index
    indices = SpendAgreementCustomFieldName.for_company(company_id)
                           .by_type(field_type)
                           .pluck(:field_index)
  ...
  def field_type_within_limit
    ...
    count = SpendAgreementCustomFieldName.for_company(company_id)
                         .by_type(field_type)
                         .count
