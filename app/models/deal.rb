...
class Deal < ActiveRecord::Base
  ...
  scope :by_type, -> (type_option_id, type_field_id) { joins(:values).where('values.field_id = ? AND values.option_id = ?', type_field_id, type_option_id) if type_option_id.present? }
  scope :by_source, -> (source_option_id, source_field_id) { joins(:values).where('values.field_id = ? AND values.option_id = ?', source_field_id, source_option_id) if source_option_id.present? }
