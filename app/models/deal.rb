    ...
    CSV.generate do |csv|
      ...
      deals.each do |deal|
        ...
        deal.deal_product_budgets.each do |deal_product_budget|
          ...
          data['Summary'][percent_key]['Q' + ((month / 3.0).ceil.to_s)] += deal_product_budget.budget
          data['Summary']['Total']['FY'] += deal_product_budget.budget
          data['Summary']['Total'][month.to_s] += deal_product_budget.budget
          data['Summary']['Total']['Q' + ((month / 3.0).ceil.to_s)] += deal_product_budget.budget
