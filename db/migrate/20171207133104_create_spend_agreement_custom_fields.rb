class CreateSpendAgreementCustomFields < ActiveRecord::Migration
  def change
    create_table :spend_agreement_custom_fields do |t|
      ...
      t.decimal :number_4_dec1, precision: 15, scale: 2
      t.decimal :number_4_dec2, precision: 15, scale: 2
      t.decimal :number_4_dec3, precision: 15, scale: 2
      t.decimal :number_4_dec4, precision: 15, scale: 2
      t.decimal :number_4_dec5, precision: 15, scale: 2
      t.decimal :number_4_dec6, precision: 15, scale: 2
      t.decimal :number_4_dec7, precision: 15, scale: 2
      t.decimal :number_4_dec8, precision: 15, scale: 2
      t.decimal :number_4_dec9, precision: 15, scale: 2
      t.decimal :number_4_dec10, precision: 15, scale: 2
      t.decimal :integer1, precision: 15, scale: 2
      t.decimal :integer2, precision: 15, scale: 2
      t.decimal :integer3, precision: 15, scale: 2
      t.decimal :integer4, precision: 15, scale: 2
      t.decimal :integer5, precision: 15, scale: 2
      t.decimal :integer6, precision: 15, scale: 2
      t.decimal :integer7, precision: 15, scale: 2
      t.decimal :integer8, precision: 15, scale: 2
      t.decimal :integer9, precision: 15, scale: 2
      t.decimal :integer10, precision: 15, scale: 2
      t.boolean :boolean1
      t.boolean :boolean2
      t.boolean :boolean3
      t.boolean :boolean4
