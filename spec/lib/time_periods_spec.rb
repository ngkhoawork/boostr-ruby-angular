...
RSpec.describe TimePeriods do
  ...
  describe '#quarters' do
    it 'returns quarters from the start/end dates' do
      ...
      expect(subject(start_date..end_date).quarters).to eq([
    ...
    it 'returns a single quarter if dates are within the same quarter' do
      ...
      expect(subject(start_date..end_date).quarters).to eq([start_date..end_date])
    end
  end
  ...
  describe '#months' do
    it 'returns months from the start/end dates' do
      ...
      expect(subject(start_date..end_date).months).to eq([
    ...
    it 'returns a single quarter if dates are within the same quarter' do
      ...
      expect(subject(start_date..end_date).months).to eq([start_date..end_date])
    end
  end

  def subject(range)
    @_subject ||= TimePeriods.new(range)
  end
end
